...
export const IDENTITY_TOOL_DEFINITIONS = [
  {
    ...
    description: "Resolve Hedera account ID or EVM address to on-chain profile: age, tokens, tx history. 0.2 HBAR.",
  ...
  },
  {
    ...
    description: "KYC status of a Hedera account for one or more tokens. 0.5 HBAR.",
  ...
  },
  {
    ...
    description: "Sanctions and risk screening for a Hedera account: tx patterns, counterparty risk. 1.0 HBAR.",
